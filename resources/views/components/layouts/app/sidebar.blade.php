                ...
                <flux:navlist variant="outline">
                    @if($user?->hasRole('Super Admin'))
                        <flux:navlist.group :heading="__('Platform')" class="grid">
                            <flux:navlist.item icon="command-line" :href="route('admin.dashboard')" :current="request()->routeIs('admin.dashboard')" wire:navigate>{{ __('Admin Console') }}</flux:navlist.item>
                            <flux:navlist.item icon="users" :href="route('admin.owners.index')" :current="request()->routeIs('admin.owners.index')" wire:navigate>{{ __('Owners') }}</flux:navlist.item>
                            <flux:navlist.item icon="map" :href="route('admin.showrooms.index')" :current="request()->routeIs('admin.showrooms.index')" wire:navigate>{{ __('Showrooms') }}</flux:navlist.item>
                            <flux:navlist.item icon="building-office-2" :href="route('admin.listings.index')" :current="request()->routeIs('admin.listings.index')" wire:navigate>{{ __('Global Listings') }}</flux:navlist.item>
                        </flux:navlist.group>

                        <flux:navlist.group :heading="__('Engagement')" class="grid">
                            <flux:navlist.item icon="chat-bubble-left-right" :href="route('admin.inquiries.index')" :current="request()->routeIs('admin.inquiries.index')" wire:navigate>{{ __('Inquiries') }}</flux:navlist.item>
                            <flux:navlist.item icon="calendar" :href="route('admin.viewing-requests.index')" :current="request()->routeIs('admin.viewing-requests.index')" wire:navigate>{{ __('Viewing Requests') }}</flux:navlist.item>
                        </flux:navlist.group>
                        ...
                        <flux:navlist.group :heading="__('Insights')" class="grid">
                            ...
                            <flux:navlist.item icon="document-chart-bar" href="#" wire:navigate>{{ __('Reports / Export') }}</flux:navlist.item>
                        </flux:navlist.group>

                        <flux:navlist.group :heading="__('SaaS')" class="grid">
                            <flux:navlist.item icon="credit-card" href="#" wire:navigate>{{ __('Plans & Billing') }}</flux:navlist.item>
                        </flux:navlist.group>

                        <flux:navlist.group :heading="__('System')" class="grid">
                            <flux:navlist.item icon="cog" href="#" wire:navigate>{{ __('Settings') }}</flux:navlist.item>
                            <flux:navlist.item icon="shield-check" href="#" wire:navigate>{{ __('Security Logs') }}</flux:navlist.item>
                            <flux:navlist.item icon="lifebuoy" href="#" wire:navigate>{{ __('Support') }}</flux:navlist.item>
                        </flux:navlist.group>
                    @else
                        <flux:navlist.group :heading="__('Platform')" class="grid">
